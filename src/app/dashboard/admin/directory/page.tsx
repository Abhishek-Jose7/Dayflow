    ...
    return (
        <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '2rem' }}>
                ...
                <Button onClick={() => setShowModal(true)} style={{ display: 'flex', gap: '0.5rem' }}>
            ...
            {/* Independent Add Employee Dialog overlay */}
            <AddEmployeeDialog show={showModal} onClose={() => setShowModal(false)} />
        </div>
    );
}
